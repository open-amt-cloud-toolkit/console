...
mock: ### run mockgen
	...
	mockgen -source ./internal/usecase/domains/interfaces.go            -package profiles_test     -mock_names Repository=MockDomainsRepository,Feature=MockDomainsFeature                      > ./internal/usecase/profiles/domains_mocks_test.go

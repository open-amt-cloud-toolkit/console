...
// Get mocks base method.
func (m *MockIEEE8021xConfigsFeature) Get(ctx context.Context, top, skip int, tenantID string) ([]dtov1.IEEE8021xConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, top, skip, tenantID)
...
// GetByName mocks base method.
func (m *MockIEEE8021xConfigsFeature) GetByName(ctx context.Context, profileName, tenantID string) (*dtov1.IEEE8021xConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByName", ctx, profileName, tenantID)
	ret0, _ := ret[0].(*dtov1.IEEE8021xConfig)
	ret1, _ := ret[1].(error)
...
// Insert mocks base method.
func (m *MockIEEE8021xConfigsFeature) Insert(ctx context.Context, p *dtov1.IEEE8021xConfig) (*dtov1.IEEE8021xConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Insert", ctx, p)
	ret0, _ := ret[0].(*dtov1.IEEE8021xConfig)
	ret1, _ := ret[1].(error)
...
// Update mocks base method.
func (m *MockIEEE8021xConfigsFeature) Update(ctx context.Context, p *dtov1.IEEE8021xConfig) (*dtov1.IEEE8021xConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, p)
	ret0, _ := ret[0].(*dtov1.IEEE8021xConfig)
	ret1, _ := ret[1].(error)

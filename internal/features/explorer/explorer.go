...
import (
	...
	amtboot "github.com/open-amt-cloud-toolkit/go-wsman-messages/pkg/wsman/amt/boot"
	...
	amtieee8021x "github.com/open-amt-cloud-toolkit/go-wsman-messages/pkg/wsman/amt/ieee8021x"
	...
	ipsalarmclock "github.com/open-amt-cloud-toolkit/go-wsman-messages/pkg/wsman/ips/alarmclock"
	"github.com/open-amt-cloud-toolkit/go-wsman-messages/pkg/wsman/ips/hostbasedsetup"
	ipsieee8021x "github.com/open-amt-cloud-toolkit/go-wsman-messages/pkg/wsman/ips/ieee8021x"
...
func Init(wsman wsman.Messages) {
	...
	Lookup[ipsalarmclock.IPS_AlarmClockOccurrence]["Get"] = Method{
		Execute: func(value string) (client.Message, error) {
			response, err := wsman.IPS.AlarmClockOccurrence.Get()
			return *response.Message, err
		},
	}

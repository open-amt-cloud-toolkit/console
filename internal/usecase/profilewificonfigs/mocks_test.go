...
// GetByProfileName mocks base method.
func (m *MockFeature) GetByProfileName(ctx context.Context, profileName, tenantID string) ([]dtov1.ProfileWiFiConfigs, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByProfileName", ctx, profileName, tenantID)
...
// Insert mocks base method.
func (m *MockFeature) Insert(ctx context.Context, p *dtov1.ProfileWiFiConfigs) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Insert", ctx, p)
	ret0, _ := ret[0].(error)
	return ret0

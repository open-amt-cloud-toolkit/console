...
//
//	mockgen -source ./internal/usecase/profilewificonfigs/interfaces.go -package wificonfigs_test -mock_names Repository=MockProfileWiFiConfigsRepository,Feature=MockProfileWiFiConfigsFeature
//
...
func (m *MockProfileWiFiConfigsRepository) CheckProfileWiFiConfigsExists(ctx context.Context, profileName, tenantID string) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProfileWiFiConfigsRepositoryMockRecorder) CheckProfileWiFiConfigsExists(ctx, profileName, tenantID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckProfileWiFiConfigsExists", reflect.TypeOf((*MockProfileWiFiConfigsRepository)(nil).CheckProfileWiFiConfigsExists), ctx, profileName, tenantID)
}
...
// CheckProfileWiFiConfigsExists mocks base method.
func (m *MockProfileWiFiConfigsFeature) CheckProfileWiFiConfigsExists(ctx context.Context, profileName, tenantID string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckProfileWiFiConfigsExists", ctx, profileName, tenantID)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
...
// CheckProfileWiFiConfigsExists indicates an expected call of CheckProfileWiFiConfigsExists.
func (mr *MockProfileWiFiConfigsFeatureMockRecorder) CheckProfileWiFiConfigsExists(ctx, profileName, tenantID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckProfileWiFiConfigsExists", reflect.TypeOf((*MockProfileWiFiConfigsFeature)(nil).CheckProfileWiFiConfigsExists), ctx, profileName, tenantID)
}

...
//
//	mockgen -source ./internal/usecase/ieee8021xconfigs/interfaces.go -package ieee8021xconfigs_test
//

// Package ieee8021xconfigs_test is a generated GoMock package.
...
func (m *MockRepository) Get(ctx context.Context, top, skip int, tenantID string) ([]entity.IEEE8021xConfig, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetByName(ctx context.Context, profileName, tenantID string) (*entity.IEEE8021xConfig, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Insert(ctx context.Context, p *entity.IEEE8021xConfig) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(ctx context.Context, p *entity.IEEE8021xConfig) (bool, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockFeature) Get(ctx context.Context, top, skip int, tenantID string) ([]dtov1.IEEE8021xConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, top, skip, tenantID)
	ret0, _ := ret[0].([]dtov1.IEEE8021xConfig)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetByName mocks base method.
func (m *MockFeature) GetByName(ctx context.Context, profileName, tenantID string) (*dtov1.IEEE8021xConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByName", ctx, profileName, tenantID)
	ret0, _ := ret[0].(*dtov1.IEEE8021xConfig)
	ret1, _ := ret[1].(error)
...
// Insert mocks base method.
func (m *MockFeature) Insert(ctx context.Context, p *dtov1.IEEE8021xConfig) (*dtov1.IEEE8021xConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Insert", ctx, p)
	ret0, _ := ret[0].(*dtov1.IEEE8021xConfig)
	ret1, _ := ret[1].(error)
...
// Update mocks base method.
func (m *MockFeature) Update(ctx context.Context, p *dtov1.IEEE8021xConfig) (*dtov1.IEEE8021xConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, p)
	ret0, _ := ret[0].(*dtov1.IEEE8021xConfig)
	ret1, _ := ret[1].(error)

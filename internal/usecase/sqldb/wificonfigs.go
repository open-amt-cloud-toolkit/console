...
var (
	ErrWiFiDatabase  = DatabaseError{Console: errors1.CreateConsoleError("WirelessRepo")}
	ErrWiFiNotUnique = NotUniqueError{Console: errors1.CreateConsoleError("WirelessRepo")}
)

...
var (
	ErrProfileDatabase  = DatabaseError{Console: errors1.CreateConsoleError("ProfileRepo")}
	ErrProfileNotUnique = DatabaseError{Console: errors1.CreateConsoleError("ProfileRepo")}
)

...
var (
	ErrCIRARepo          = errors1.CreateConsoleError("CIRARepo")
	ErrCIRARepoDatabase  = DatabaseError{Console: errors1.CreateConsoleError("CIRARepo")}
	ErrCIRARepoNotUnique = NotUniqueError{Console: errors1.CreateConsoleError("CIRARepo")}
)

...
//
//	mockgen -source ./internal/usecase/amtexplorer/interfaces.go -package amtexplorer_test
//

// Package amtexplorer_test is a generated GoMock package.
...
func (m *MockFeature) ExecuteCall(ctx context.Context, guid, call, tenantID string) (*v1.Explorer, error) {
	m.ctrl.T.Helper()
...
func (m *MockWSMAN) SetupWsmanClient(device v1.Device, logMessages bool) amtexplorer.AMTExplorer {
	m.ctrl.T.Helper()
...
func (mr *MockWSMANMockRecorder) SetupWsmanClient(device, logMessages any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetupWsmanClient", reflect.TypeOf((*MockWSMAN)(nil).SetupWsmanClient), device, logMessages)
}
